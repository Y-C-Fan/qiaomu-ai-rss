...
export const stateSchema = z.object({
  settings: z.object({
    ...
    selectionPopup: z.boolean().default(true), outline: z.boolean().default(true), markdownFolders: z.array(z.string()).default([]),
    ...
    fontSize: 19, fontFamily: 'fangsong', customFont: '', lineHeight: 1.9, lineWidth: 36, lastSource: '', selectionPopup: true, outline: true, markdownFolders: [] }),
